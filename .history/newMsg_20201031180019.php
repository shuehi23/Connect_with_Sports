...
if(!empty($viewData)) {
    ...
    if(($key = array_search($_SESSION['user_id'], $partnerUserId)) !== false) {
        unset($partnerUserId[$key]);
    }
    $partnerUserId = array_shift($partnerUserId);
    // 相手のユーザー情報を取得
                    ...
                    <div class="content-wrap">
                        <div class="posted con">
                            ...
                            <ul class="flex">
                                ...
                                ?>
                                        <li>
                                            <a href="msg.php<?php echo sanitize($msg['bord_id']); ?>">
                                                <dl>
