                        ...
                        foreach ($viewData as $key => $val) {
                            if (!empty($val['from_user']) && $val['from_user'] == $h_id) { ?>
                                <li class="left-msg msg">
                                    <dl class="flex">
                                        <dt><a class="raf" href="profDetail.php<?php echo (empty($h_id)) ? appendGet() . '&h_id=' . $viewData['posted_id'] : appendGet(); ?>"><img src="<?php echo showProfImg(sanitize($receiverInfo['pic'])); ?>" alt="" class="avater"></a></dt>
                                        <dd>
